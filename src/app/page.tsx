...
export default function Home() {
  ...
  const generateAnswer = async (): Promise<void> => {
    ...
    try {
      ...
      }, 500); // Adjust speed of typing (200ms between words)
    } catch (error) {
...
<div className="min-h-screen min-w-screen flex items-center justify-center dark:bg-gray-800 p-4 sm:p-6 md:p-3">
  ...
  <h1 className="text-3xl sm:text-3xl font-bold mb-4 text-center">
    ...
    <div
      className="flex-grow overflow-y-auto] dark:bg-gray-800  rounded-lg mb-12"  // 'mb-12' to create space for the input field
    ...
    <div className="flex items-center space-x-2 w-full p-4 bg-white dark:bg-gray-800 fixed bottom-0 left-0">
      <input
        type="text"
        className="border-1 border-fuchsia-300 shadow-xs bg-gray-50 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-xs-light"
